...
import { useDownloadPublicWorkDocx } from "../../core/network/queries/publicWork/mutations"
...
export function ListPublicWork() {
  ...
  const { mutate: download } = useDownloadPublicWorkDocx()
                          ...
                          <TableCell align="center">
                            <Tooltip title="Baixar Relatório">
                              <IconButton
                                color="info"
                                size="small"
                                onClick={() => download(publicWork.id)}
                              >
                                <FileDownloadOutlined />
                              </IconButton>
                            </Tooltip>
