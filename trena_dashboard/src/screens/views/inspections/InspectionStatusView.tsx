...
export default class InspectionStatusView extends BaseCRUDView<InspectionStatusViewProps, InspectionCRUDViewState> {
    ...
    render() {
        return (
            <div className="container has-text-left">
                 <Dropdown inputLabel="Status"
                          optionsList={[{key:"0", value: "Nova"},{key:"1", value: "Pendente"}, {key:"2", value: "Verificada"}, {key:"3", value: "Negada"}]}
